...
<body>
    ...
    <section class="main-content container">
        ...
        <h2>취득 시 활용 분야</h2>
        <ul>
            <li>드론 방제 (농약, 비료, 약제 살포 등)</li>
            <li>대학 진학</li>
            <li>군 특기병 지원</li>
            <li>관공서 공공기관 취업</li>
            <li>드론 제작/개발/정비/교육 등</li>
        </ul>
        
        <h2>전문 교육과정 안내</h2>
        <p>전문 교육과정은 드론 조종 및 운용에 대한 깊이 있는 이해와 전문적인 기술 습득을 목표로 합니다.
        이 과정은 이론 학습과 실습을 통해 안전한 드론 조종 능력과 고급 운용 기술을 배우고자 하는 개인에게 이상적입니다.</p>
        ...
        <table border="1" cellspacing="0" cellpadding="10">
            ...
            <tr>
                <td colspan="3">총 교육시간 60시간 (필수)</td>
            </tr>
        </table>
        
        <h2>속성 교육과정 안내</h2>
        <p>속성 교육과정은 짧은 시간 내에 드론 조종과 기본 운용 능력을 배울 수 있는 집중 과정입니다.
        이 과정은 드론에 대한 기본적인 이해와 실습을 통해 조종 자격증 취득을 목표로 하는 학습자에게 적합합니다.</p>
        ...
        <table border="1" cellspacing="0" cellpadding="10">
            ...
            <tr>
                <td colspan="3">총 교육시간 29시간 (필수 23시간 선택 6시간)</td>
            </tr>
        </table>
    </section>
    <footer class="footer">
